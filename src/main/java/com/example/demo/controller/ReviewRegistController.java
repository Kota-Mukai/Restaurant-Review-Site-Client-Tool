...
import com.example.demo.service.ReviewRegistService;
...
public class ReviewRegistController {
	...
	private final ReviewRegistService service;
	...
	public String confirmRegistReview(
		...
		redirectAttributes.addFlashAttribute("msg", "Review Registration");
